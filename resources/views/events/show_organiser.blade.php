...
<div id="blue">
    ...
    <div class="row">
      ...
      <div class="col-md-2">
          <a href="{{ route('events.edit', ['id' => $event->id]) }}" class="btn btn-lg btn-block btn-primary">Edit</a>
          {!! Form:open(['route' => ['events.destroy', $event->id], 'method' => 'DELETE']) !!}
          {!! Form::submit('Delete', ['class' => 'btn btn-lg btn-block btn-danger']) !!}
          {!! Form::close() !!}
          <a href="{{ route('events.index') }}" class="btn btn-lg btn-block btn-primary">See All Events</a>
